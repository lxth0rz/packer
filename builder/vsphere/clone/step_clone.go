...
type vAppConfig struct {
	// Set values for the available vApp Properties to supply configuration parameters
...
type CloneConfig struct {
	...
	// See the [vApp Configuration](/docs/builders/vmware/vsphere-clone#vapp-options-configuration)
